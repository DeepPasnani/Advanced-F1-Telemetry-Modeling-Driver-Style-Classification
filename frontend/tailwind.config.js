...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ['Formula1', 'system-ui', 'sans-serif'],
        wide: ['Formula1 Wide', 'Formula1', 'system-ui', 'sans-serif'],
      ...
      colors: {
        ...
        gray: {
          400: '#a0a0a6', 500: '#6b6b72', 600: '#4a4a50', 700: '#2a2a2e',
          800: '#1e1e22', 900: '#141416', 950: '#0a0a0c',
        },
      },
